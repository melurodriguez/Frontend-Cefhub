...
const user2=require('../assets/user2.svg')
const user3=require('../assets/user3.svg')
const user4=require('../assets/user4.svg')
const user5=require('../assets/user5.svg')
const user6=require('../assets/user6.svg')
